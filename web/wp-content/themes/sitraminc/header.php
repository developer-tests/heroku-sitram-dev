...
<script src="<?php echo get_template_directory_uri(); ?>/assets/jquery-3.5.1.slim.min.js" ></script> 
...
<body <?php body_class(); ?>>
<?php wp_body_open(); ?>
<div id="main-header" class="sit-header-1">
<nav class="navbar navbar-expand-lg navbar-light fixed-top">
  <div class="container"> <a href="<?php echo get_home_url(); ?>"><img src="<?php echo get_template_directory_uri(); ?>/images/1-Logo-Horizontal-Light-BG.png" /></a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <div class="search">
        <form role="search" method="get" class="search-form example" action="<?php echo home_url( '/' ); ?>">
          <input type="text" placeholder="Search" style="color:black;" name="s">
