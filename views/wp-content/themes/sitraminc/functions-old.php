...
function twentytwelve_widgets_init() {
	...
	register_sidebar(
		array(
			'name'          => __( 'Footer Intro Text Widget Area', 'twentytwelve' ),
			'id'            => 'sidebar-2',
			'description'   => __( 'Appears when using the Footer Intro Text Widget Area', 'twentytwelve' ),
			'before_widget' => '',
			'after_widget'  => '',
		)
	);
	...
	register_sidebar(
		array(
			'name'          => __( 'Footer Menu Widget Area', 'twentytwelve' ),
			'id'            => 'sidebar-3',
			'description'   => __( 'Appears when using the Footer Menu Widget Area', 'twentytwelve' ),
			'before_widget' => '',
			'after_widget'  => '',
		)
	);
...
function product_register() {   
    ...
    $args = array( 
        ...
        'rewrite' => array( 'slug' => 'sitram-product', 'with_front'=> false ), 
    ...
    register_taxonomy_for_object_type( 'categories', 'product' ); // Better be safe than sorry
}
