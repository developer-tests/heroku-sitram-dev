<?php
/**
 * Plugin Name: YITH WooCommerce Wishlist Extended
...
if ( ! defined( 'YITH_WCWL_FILE' ) ) {
	define( 'YITH_WCWL_FILE', __FILE__ );
}
...
if ( ! defined( 'YITH_WCWL_EXTENDED' ) ) {
	define( 'YITH_WCWL_EXTENDED', '1' );
}

if ( ! defined( 'YITH_WCWL_EXTENDED_INIT' ) ) {
	define( 'YITH_WCWL_EXTENDED_INIT', plugin_basename( __FILE__ ) );
}
...
if ( ! function_exists( 'yith_wishlist_extended_constructor' ) ) {
	/**
	 ...
	 * @since 2.0.0
	 */
	function yith_wishlist_extended_constructor() {
...
if ( ! function_exists( 'yith_wishlist_install' ) ) {
	...
	function yith_wishlist_install() {
		...
		if ( ! function_exists( 'WC' ) ) {
			...
			yith_deactivate_plugins( 'YITH_WCWL_EXTENDED_INIT' );
		} else {
...
add_action( 'yith_wcwl_init', 'yith_wishlist_extended_constructor' );
add_action( 'plugins_loaded', 'yith_wishlist_install', 11 );

if ( file_exists( YITH_WCWL_DIR . '/hiive-autoupdate.php' ) ) {
	require_once YITH_WCWL_DIR . '/hiive-autoupdate.php';
}
