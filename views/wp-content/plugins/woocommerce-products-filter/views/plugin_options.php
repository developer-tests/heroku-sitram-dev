...
<div class="subsubsub_section <?php esc_attr_e($this->show_notes ? "woof_free" : "") ?>">
    ...
    <section class="woof-section">
        ...
        <div class="woof-header">
            <div>
                <h3 class="woof_plugin_name"><?php esc_html_e('WOOF - WooCommerce Products Filter', 'woocommerce-products-filter') ?>&nbsp;<span class="woof__text-success">v.<?php esc_attr_e(WOOF_VERSION) ?></span>&nbsp;<span id="woof-head"><svg><use xlink:href="#svg-woof"></use></svg></span></h3>
                                    ...
                                    <?php foreach ($skins as $key => $schemes) : ?>
                                        <optgroup label="<?php esc_attr_e($key) ?>">
                                            <?php foreach ($schemes as $scheme) : ?>
                                                <option value="<?php esc_attr_e($scheme) ?>" <?php selected($skin == $scheme) ?>><?php esc_attr_e($scheme) ?></option>
                                            <?php endforeach; ?>
                                        </optgroup>
                                    <?php endforeach; ?>
                                </select>
                            ...
                            <div class="woof-control">
                                ...
                                <select name="woof_settings[overlay_skin]" class="chosen_select">
                                    <?php foreach ($skins as $scheme => $title) : ?>
                                        <option value="<?php esc_attr_e($scheme) ?>" <?php selected($skin == $scheme) ?>><?php esc_html_e($title) ?></option>
                                    <?php endforeach; ?>
                                </select>
                                ...
                                <div class="select-wrap"> 
                                    <select name="woof_settings[select_design]" class="chosen_select">
                                        <?php foreach ($select_designs as $key => $value) : ?>
                                            <option value="<?php esc_attr_e($key) ?>" <?php selected($select_design == $key) ?>><?php esc_html_e($value) ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                                ...
                                <div class="select-wrap">
                                    <select name="woof_settings[use_beauty_scroll]" class="chosen_select">
                                        <?php foreach ($use_beauty_scroll as $key => $value) : ?>
                                            <option value="<?php esc_attr_e($key) ?>" <?php selected($use_scroll == $key) ?>><?php esc_html_e($value) ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                                ...
                                <div class="select-wrap">
                                    <select name="woof_settings[ion_slider_skin]" class="chosen_select">
                                        <?php foreach ($skins as $key => $value) : ?>
                                            <option value="<?php esc_attr_e($key) ?>" <?php selected($skin == $key) ?>><?php esc_html_e($value) ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                                ...
                                <div class="select-wrap">
                                    <select name="woof_settings[use_tooltip]" class="chosen_select">
                                        <?php foreach ($tooltip_selects as $key => $value) : ?>
                                            <option value="<?php esc_attr_e($key) ?>" <?php selected($tooltip_select == $key) ?>><?php esc_html_e($value) ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                                ...
                                <div class="woof-control">
                                    ...
                                    <select name="woof_settings[woof_auto_hide_button]" class="chosen_select">
                                        <?php foreach ($woof_auto_hide_button as $v => $n) : ?>
                                            <option value="<?php esc_attr_e($v) ?>" <?php selected($woof_auto_hide_button_val == $v) ?>><?php esc_html_e($n) ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                ...
                                <div class="woof-control">
                                    ...
                                    <select name="woof_settings[woof_auto_filter_skins]" class="chosen_select">
                                        <?php foreach ($woof_auto_filter_skins as $v => $n) : ?>
                                            <option value="<?php esc_attr_e($v) ?>" <?php selected($woof_auto_filter_skins_val == $v) ?>><?php esc_html_e($n) ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                ...
                                <div class="select-wrap">
                                    <select name="woof_settings[toggle_type]" class="chosen_select" id="toggle_type">
                                        <?php foreach ($toggle_types as $key => $value) : ?>
                                            <option value="<?php esc_attr_e($key) ?>" <?php selected($toggle_type == $key) ?>><?php esc_html_e($value) ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                                                        ...
                                                        <div class="select-wrap">
                                                            <select name="woof_settings[init_only_on_reverse]">
                                                                <?php foreach ($init_only_on_r as $key => $value) : ?>
                                                                    <option value="<?php esc_attr_e($key) ?>" <?php selected($woof_settings['init_only_on_reverse'] == $key) ?>><?php esc_html_e($value) ?></option>
                                                                <?php endforeach; ?>
                                                            </select>
                                                        </div>
                                        ...
                                        <div class="woof-control">
                                            ...
                                            <select name="woof_settings[optimize_js_files]">
                                                <?php foreach ($optimize_js_files as $key => $value) : ?>
                                                    <option value="<?php esc_attr_e($key) ?>" <?php selected($woof_settings['optimize_js_files'] == $key) ?>><?php esc_html_e($value) ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        ...
                                        <div class="woof-control">
                                            ...
                                            <select name="woof_settings[show_images_by_attr_show]">
                                                <?php foreach ($show_images_by_attr as $key => $value) : ?>
                                                    <option value="<?php esc_attr_e($key) ?>" <?php selected($woof_settings['show_images_by_attr_show'] == $key) ?>><?php esc_html_e($value) ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                            ...
                                            <div class="select-wrap chosen_select" <?php if (!$woof_settings['show_images_by_attr_show']) : ?> style='display:none;' <?php endif; ?> >
                                                <select  class="chosen_select" multiple name="woof_settings[show_images_by_attr][]">
                                                    <?php foreach ($attributes as $attr) : ?>
                                                        <option value="pa_<?php esc_attr_e($attr->attribute_name) ?>" <?php selected(in_array('pa_' . $attr->attribute_name, $woof_settings['show_images_by_attr'])) ?>><?php esc_html_e($attr->attribute_label) ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                            </div>
                                        ...
                                        <div class="woof-control">
                                            ...
                                            <select name="woof_settings[hide_terms_count_txt]">
                                                <?php foreach ($hide_terms_count_txt as $key => $value) : ?>
                                                    <option value="<?php esc_attr_e($key) ?>" <?php selected($woof_settings['hide_terms_count_txt'] == $key) ?>><?php esc_html_e($value) ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        ...
                                        <div class="woof-control">
                                            ...
                                            <select name="woof_settings[listen_catalog_visibility]">
                                                <?php foreach ($listen_catalog_visibility as $key => $value) : ?>
                                                    <option value="<?php esc_attr_e($key) ?>" <?php selected($woof_settings['listen_catalog_visibility'] == $key) ?>><?php esc_html_e($value) ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        ...
                                        <div class="woof-control">
                                            ...
                                            <select name="woof_settings[disable_swoof_influence]">
                                                <?php foreach ($disable_swoof_influence as $key => $value) : ?>
                                                    <option value="<?php esc_attr_e($key) ?>" <?php selected($woof_settings['disable_swoof_influence'] == $key) ?>><?php esc_html_e($value) ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                            ...
                                            <div class="woof-control">
                                                ...
                                                <select name="woof_settings[cache_count_data]">
                                                    <?php foreach ($cache_count_data as $key => $value) : ?>
                                                        <option value="<?php esc_attr_e($key) ?>" <?php selected($woof_settings['cache_count_data'] == $key) ?>><?php esc_html_e($value) ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                            ...
                                            <div class="woof-control">
                                                ...
                                                <select name="woof_settings[cache_terms]">
                                                    <?php foreach ($cache_terms as $key => $value) : ?>
                                                        <option value="<?php esc_attr_e($key) ?>" <?php selected($woof_settings['cache_terms'] == $key) ?>><?php esc_html_e($value) ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                            ...
                                            <div class="woof-control">
                                                ...
                                                <select name="woof_settings[price_transient]">
                                                    <?php foreach ($price_transient as $key => $value) : ?>
                                                        <option value="<?php esc_attr_e($key) ?>" <?php selected($woof_settings['price_transient'] == $key) ?>><?php esc_html_e($value) ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                        ...
                                        <div class="woof-control">
                                            ...
                                            <select id="show_woof_edit_view" name="woof_settings[show_woof_edit_view]">
                                                <?php foreach ($show_woof_edit_view as $key => $value) : ?>
                                                    <option value="<?php esc_attr_e($key) ?>" <?php selected($woof_settings['show_woof_edit_view'] == $key) ?>><?php esc_html_e($value) ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        ...
                                        <ul class="woof_extensions woof_custom_extensions">
                                            ...
                                            <?php foreach ($extensions['custom'] as $dir): ?>
                                                ...
                                                <li class="woof_ext_li <?php esc_attr_e($checked ? 'is_enabled' : 'is_disabled'); ?>">
                                                    ...
                                                    <div class="woof_ext-cell">
                                                        <a href="javascript:void(0)" class="woof_ext_remove" data-idx="<?php esc_attr_e($idx) ?>" title="<?php esc_html_e('remove extension', 'woocommerce-products-filter') ?>">
                                                ...
                                                if (!empty(WOOF_EXT::$includes['applications'])) {
                                                    foreach (WOOF_EXT::$includes['applications'] as $obj) {
                                                        ...
                                                        <li>
                                                            ...
                                                            ?>
                                                            <a href="#tabs-<?php esc_attr_e($obj->folder_name) ?>" title="<?php printf(esc_html__("%s", 'woocommerce-products-filter'), $name) ?>">
...
function woof_print_tax($key, $tax, $woof_settings) {
    ...
    <li data-key="<?php esc_attr_e($key) ?>" class="woof_options_li">
        ...
        ?>
        <input <?php checked($rev_checked) ?> type="checkbox" name="woof_settings[excluded_terms_reverse][<?php esc_attr_e($key) ?>]" id="<?php esc_attr_e($rev_id) ?>" value="1" />
        ...
        <input <?php checked($tax_checked) ?> type="checkbox" name="woof_settings[tax][<?php esc_attr_e($key) ?>]" id="tax_<?php esc_attr_e(md5($key)) ?>" value="1" />
    ...
    switch ($key) {
        case 'by_price':
            ...
            <li data-key="<?php esc_attr_e($key) ?>" class="woof_options_li">
                ...
                <input type="hidden" name="woof_settings[<?php esc_attr_e($key) ?>][ion_slider_step]" value="<?php echo floatval($woof_settings[$key]['ion_slider_step']) ?>" />
