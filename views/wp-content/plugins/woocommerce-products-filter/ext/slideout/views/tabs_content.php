...
<?php foreach ($slideout_show as $key => $value) : ?>
                                        <option value="<?php esc_attr_e($key) ?>" <?php selected($woof_settings['woof_slideout_show'] == $key) ?>><?php esc_html_e($value) ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
...
<?php foreach ($slideout_type_btn as $key => $value) : ?>
                                        <option value="<?php esc_attr_e($key) ?>" <?php selected($woof_settings['woof_slideout_type_btn'] == $key) ?>><?php esc_html_e($value) ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
...
<?php foreach ($slideout_position as $key => $value) : ?>
                                        <option value="<?php esc_attr_e($key) ?>" <?php selected($woof_settings['woof_slideout_position'] == $key) ?>><?php esc_html_e($value) ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
...
<?php foreach ($slideout_action as $key => $value) : ?>
                                        <option value="<?php esc_attr_e($key) ?>" <?php selected($woof_settings['woof_slideout_action'] == $key) ?>><?php esc_html_e($value) ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
...
<?php foreach ($slideout_offset_t as $key => $value) : ?>
                                        <option value="<?php esc_attr_e($key) ?>" <?php selected($woof_settings['woof_slideout_offset_t'] == $key) ?>><?php esc_html_e($value) ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </span>    
                        </div>
...
<?php foreach ($slideout_wh_t as $key => $value) : ?>
                                        <option value="<?php esc_attr_e($key) ?>" <?php selected($woof_settings['woof_slideout_width_t'] == $key) ?>><?php esc_html_e($value) ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </span> 
                            <span>X</span>
...
<?php foreach ($slideout_wh_t as $key => $value) : ?>
                                        <option value="<?php esc_attr_e($key) ?>" <?php selected($woof_settings['woof_slideout_height_t'] == $key) ?>><?php esc_html_e($value) ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </span>                                 
                        </div>
...
<?php foreach ($slideout_open as $key => $value) : ?>
                                        <option value="<?php esc_attr_e($key) ?>" <?php selected($woof_settings['woof_slideout_open'] == $key) ?>><?php esc_html_e($value) ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
...
<?php foreach ($slideout_mobile as $key => $value) : ?>
                                        <option value="<?php esc_attr_e($key) ?>" <?php selected($woof_settings['woof_slideout_mobile'] == $key) ?>><?php esc_html_e($value) ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
