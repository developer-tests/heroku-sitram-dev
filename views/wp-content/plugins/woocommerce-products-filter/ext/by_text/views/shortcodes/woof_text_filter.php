...
<div data-css-class="woof_text_search_container" class="woof_text_search_container woof_container woof_container_woof_text">
    ...
    <div class="woof_container_inner">
        ...
        <label class="woof_wcga_label_hide" for="<?php esc_attr_e($search_id) ?>"><?php esc_html_e('Text search', 'woocommerce-products-filter') ?></label>
        <?php
        $woof_text = '';
        ...
        ?>
        <input type="search" class="woof_husky_txt-input" id="<?php esc_attr_e($search_id) ?>"
        <?php
