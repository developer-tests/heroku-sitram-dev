<?php
/*
  Plugin Name: Products Filter for WooCommerce
...
//
    ...
    public function wp_load_js() {
        ...
        var woof_checkboxes_slide_flag = <?php esc_attr_e((int) get_option('woof_checkboxes_slide') === 1 ? 1 : 0); ?>;
    ...
    public function wp_footer() {
        if (isset($this->settings['overlay_skin']) AND ( $this->settings['overlay_skin'] != 'default' AND $this->settings['overlay_skin'] != 'plainoverlay')) {
            ...
            <img  style="display: none;" src="<?php echo esc_url(WOOF_LINK) ?>img/loading-master/<?php esc_attr_e($this->settings['overlay_skin']) ?>.svg" alt="preloader" />
