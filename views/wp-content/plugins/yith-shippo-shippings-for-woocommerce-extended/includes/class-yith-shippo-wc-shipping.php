...
class YITH_Shippo_WC_Shipping extends WC_Shipping_Method {
	...
	protected function can_calculate_shipping() {
		...
		$is_api_url      = yith_shippo_is_request_for_url( '/wp-json/wc/store/v1/batch?_locale=user' ) || yith_shippo_is_request_for_url( '/wp-json/wc/store/v1/checkout?_locale=user' );
