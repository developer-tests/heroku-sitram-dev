 ...
 */
class EasypostWfTrackingFactory {
	public static function init() {
		self::wf_include_once( 'EasypostWfTrackingAbstract', 'class-wf-tracking-common.php' );
		self::wf_include_once( 'EasypostWfTrackingAbstract', 'class-wf-tracking-abstract.php' );
	}
