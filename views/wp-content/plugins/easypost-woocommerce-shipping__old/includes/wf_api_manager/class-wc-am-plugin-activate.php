...
use Elex\EP\API_Manager_Password_Management;
...
class WF_Software_Activate {
	...
	public function wf_activation() {
		...
		$args = array(
			...
			'request'          => 'activation',
			'product_id'       => ! empty( $this->activation_unique_product_id ) ? $this->activation_unique_product_id : $this->product_id,
			'instance'         => $instance,
		...
		if ( is_wp_error( $response ) ) {
			...
			if ( ! isset( $response_array['error'] ) && isset( $response_array['activated'] ) && true == $response_array['activated'] ) {
				...
				$single_options = array(
					...
					$this->wf_unique_product_id_key     => ! empty( $this->activation_unique_product_id ) ? $this->activation_unique_product_id : $this->product_id,
				);
	...
	public function wf_deactivation() {
		...
		$args = array(
			...
			'product_id'  => ! empty( $activation_unique_product_id ) ? $activation_unique_product_id : ( ! empty( $this->activation_unique_product_id ) ? $this->activation_unique_product_id : $this->product_id ),
