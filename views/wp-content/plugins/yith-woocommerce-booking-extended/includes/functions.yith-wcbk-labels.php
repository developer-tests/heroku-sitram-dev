...
if ( ! function_exists( 'yith_wcbk_format_duration' ) ) {
	...
	function yith_wcbk_format_duration( $duration, $unit, $mode = 'duration' ) {
		...
		$formatted_duration = ! ! $label_string ? sprintf( $label_string, $duration ) : '';

		/**
		 * APPLY_FILTERS: yith_wcbk_format_duration
		 *
		 ...
		 * @return string
		 */
		return apply_filters( 'yith_wcbk_format_duration', $formatted_duration, $duration, $unit );
	}
}
...
if ( ! function_exists( 'yith_wcbk_get_booking_meta_label' ) ) {
	...
	function yith_wcbk_get_booking_meta_label( $key ) {
		/**
		 * APPLY_FILTERS: yith_wcbk_booking_meta_labels
		 *
		...
		/**
		 * APPLY_FILTERS: yith_wcbk_get_booking_meta_label
		 *
		 * Filters the label for a specific booking meta.
		 *
		 * @param string $label               The label.
		 * @param string $key                 The key.
		 * @param array  $booking_meta_labels The booking meta labels.
		 *
		 * @return string
		 */
...
if ( ! function_exists( 'yith_wcbk_get_duration_label' ) ) {
	...
	function yith_wcbk_get_duration_label( $duration, $duration_unit, $mode ) {
		...
		/**
		 * APPLY_FILTERS: yith_wcbk_get_duration_label
		 *
...
if ( ! function_exists( 'yith_wcbk_get_duration_label_string' ) ) {
	...
	function yith_wcbk_get_duration_label_string( $duration_unit, $plural = false, $mode = 'duration' ) {
		...
		/**
		 * APPLY_FILTERS: yith_wcbk_get_duration_label_string
		 *
