...
if ( ! class_exists( 'YITH_WCBK_Data' ) ) {
	...
	abstract class YITH_WCBK_Data extends WC_Data {
		...
		public function save() {
			...
			/**
			 * DO_ACTION: yith_wcbk_before_{$object_type}_object_save
			 * Hook to perform any action before saving an object.
			 *
			 * @param YITH_WCBK_Data $this       The object.
			 * @param object         $data_store The data store.
			 */
			...
			/**
			 * DO_ACTION: yith_wcbk_after_{$object_type}_object_save
