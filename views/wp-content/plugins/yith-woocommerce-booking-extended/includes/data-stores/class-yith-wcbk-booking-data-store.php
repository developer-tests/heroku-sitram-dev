...
class YITH_WCBK_Booking_Data_Store extends WC_Data_Store_WP implements WC_Object_Data_Store_Interface {
	...
	public function create( &$booking ) {
		...
		if ( $id && ! is_wp_error( $id ) ) {
			...
			/**
			 * DO_ACTION: yith_wcbk_booking_created
			...
			/**
			 * DO_ACTION: yith_wcbk_new_booking
			 * Hook to perform any action when a booking is created.
			 *
	...
	public function read( &$booking ) {
		...
		/**
		 * DO_ACTION: yith_wcbk_booking_read
	...
	public function update( &$booking ) {
		...
		/**
		 * DO_ACTION: yith_wcbk_booking_updated
		...
		/**
		 * DO_ACTION: yith_wcbk_update_booking
		 * Hook to perform any action when a booking is updated.
		 *
		 * @param int               $id      The booking ID.
		 * @param YITH_WCBK_Booking $booking The booking.
	...
	public function delete( &$booking, $args = array() ) {
		...
		if ( $args['force_delete'] ) {
			/**
			 * DO_ACTION: yith_wcbk_before_delete_booking
			...
			/**
			 * DO_ACTION: yith_wcbk_delete_booking
			...
			/**
			 * DO_ACTION: yith_wcbk_trash_booking
	...
	protected function read_booking_data( &$booking ) {
		...
		/**
		 * DO_ACTION: yith_wcbk_booking_data_store_read_data
		 * Hook to perform any action when reading data for a booking.
		 *
		 * @param YITH_WCBK_Booking            $booking    The booking.
		 * @param YITH_WCBK_Booking_Data_Store $data_store The data store.
		 */
	...
	protected function handle_updated_props( &$booking ) {
		...
		/**
		 * DO_ACTION: yith_wcbk_booking_data_store_updated_props
	...
	protected function clear_caches( &$booking ) {
		...
		/**
		 * DO_ACTION: yith_wcbk_booking_data_store_clear_caches
