...
class YITH_WCBK_Global_Price_Rule_Data_Store extends YITH_WCBK_Custom_Table_Data_Store {
	...
	public function create( &$rule ) {
		...
		if ( $id ) {
			...
			/**
			 * DO_ACTION: yith_wcbk_global_price_rule_created
	...
	public function read( &$rule ) {
		...
		/**
		 * DO_ACTION: yith_wcbk_global_price_rule_read
	...
	public function update( &$rule ) {
		...
		if ( $updated ) {
			...
			/**
			 * DO_ACTION: yith_wcbk_global_price_rule_updated
	...
	public function delete( &$rule, $args = array() ) {
		...
		if ( $id ) {
			...
			if ( $object ) {
				/**
				 * DO_ACTION: yith_wcbk_global_price_rule_before_delete
				...
				/**
				 * DO_ACTION: yith_wcbk_global_price_rule_deleted
