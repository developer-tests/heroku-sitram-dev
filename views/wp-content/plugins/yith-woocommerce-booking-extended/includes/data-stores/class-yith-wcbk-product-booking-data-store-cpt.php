...
class YITH_WCBK_Product_Booking_Data_Store_CPT extends WC_Product_Data_Store_CPT implements WC_Object_Data_Store_Interface {
	...
	public function read_product_data( &$product ) {
		...
		/**
		 * DO_ACTION: yith_wcbk_product_data_store_read_data
		 * Hook to perform any action when reading data for a bookable product.
		 *
		 * @param WC_Product_Booking                       $product    The bookable product.
		 * @param YITH_WCBK_Product_Booking_Data_Store_CPT $data_store The data store.
		 */
	...
	protected function handle_updated_props( &$product ) {
		...
		/**
		 * DO_ACTION: yith_wcbk_product_data_store_updated_props
	...
	public function sync_booking_price( $product ) {
		...
		if ( $product && $product->is_type( 'booking' ) ) {
			...
			/**
			 * DO_ACTION: yith_wcbk_product_sync_price_after
