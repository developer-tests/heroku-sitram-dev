...
$deprecated_filters_map = array(
	...
	array(
		'deprecated' => 'yith_wcbk_get_bookings_by_order',
		'since'      => '5.7.0',
		'use'        => 'yith_wcbk_pre_get_bookings_by_order',
		'params'     => 3,
	),
);
...
if ( ! function_exists( 'yith_wcbk_get_order_awaiting_payment' ) ) {
	...
	function yith_wcbk_get_order_awaiting_payment() {
		yith_wcbk_deprecated_function( 'yith_wcbk_get_order_awaiting_payment', '5.8.1' );
