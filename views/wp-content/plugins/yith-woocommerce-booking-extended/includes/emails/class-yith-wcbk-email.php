	...
	abstract class YITH_WCBK_Email extends WC_Email {
		...
		protected function prepare_and_send() {
			if ( $this->object && $this->object->is_valid() ) {
				...
				/**
				 * DO_ACTION: yith_wcbk_email_before_sending
				 * Hook to perform any action before sending email.
				 *
				 * @param YITH_WCBK_Email $email             The email..
				 * @param bool            $is_customer_email True if is a mail for the customer.
				 */
				...
				/**
				 * DO_ACTION: yith_wcbk_email_after_sending
		...
		protected function init_placeholders_before_sending() {
			if ( $this->object && $this->object->is_valid() ) {
				...
				ob_start();
				/**
				 * DO_ACTION: yith_wcbk_email_booking_details
