...
if ( ! class_exists( 'YITH_WCBK_Endpoints' ) ) {
	...
	class YITH_WCBK_Endpoints {
		...
		private function init_vars() {
			/**
			 * APPLY_FILTERS: yith_wcbk_booking_endpoints
			 *
		...
		public function add_booking_endpoint_in_myaccount_menu( $items ) {
			 ...
			 * @return string
			 */
			$the_bookings_endpoint = apply_filters( 'yith_wcbk_endpoint_bookings', 'bookings' );

			$bookings_endpoint = $this->get_endpoint( $the_bookings_endpoint );
		...
		public function get_current_endpoint() {
			...
			/**
			 * APPLY_FILTERS: yith_wcbk_is_current_endpoint
			 *
			 * Filters if this is the current endpoint.
			 *
			 * @param bool $is_current_endpoint True if we're in the current endpoint; false otherwise.
			 *
			 * @return bool
			 */
		...
		public function show_endpoint() {
			...
			switch ( $endpoint ) {
				case $bookings_endpoint:
					...
					/**
					 * APPLY_FILTERS: yith_wcbk_my_account_bookings_per_page
					 *
					 * Filters the number of bookings to be shown per page in the "My Account > Bookings" page.
					 *
					 * @param int $per_page The number of bookings to be shown per page.
					 *
					 * @return int
					 */
